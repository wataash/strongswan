...
/**
 * Get the ciphertext which has already been generated by set_public_key
 */
static bool get_ciphertext(private_oqs_kem_t *this, chunk_t *value)
{
	if (!this->ciphertext)
	{
		return FALSE;
	...
	private_oqs_kem_t *this, chunk_t *value)
{
	...
	if (this->ciphertext)
	{
		return get_ciphertext(this, value);
	}
